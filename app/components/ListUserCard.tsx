      ...
      <div className="hidden items-center justify-between px-10 mt-4 md:flex">
        <div className="flex items-center gap-2 flex-wrap">
          {/* <div className="group relative">
            <Link href={`/${user._id}`} className="min-w-[44px]">
              <Image src={imageProfile} alt="profile" width={44} height={44} className="object-cover w-11 h-11 rounded-full" />
            </Link>
            <div className="absolute top-12 opacity-0 transform transition-all -z-10 duration-500 group-hover:md:block group-hover:z-50 group-hover:opacity-100">
        ...
        <button onClick={() => handleFollow(_id)} className={`${alreadyFollow ? "bg-[#262626]" : "bg-[#0195f7]"} py-1 w-[25%] text-xs text-center rounded-md font-semibold hover:bg-[#A8A8A8]`}>
