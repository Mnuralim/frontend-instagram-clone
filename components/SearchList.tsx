    ...
    <>
      {user && !history && (
        <div
          ...
          className="items-center relative flex justify-between px-2 py-2 hover:bg-[#1A1A1A] cursor-pointer md:px-5"
        >
      ...
      {!user && history && (
        <div
          onClick={() => addToHistory(history.savedUser._id)}
          className="items-center relative flex justify-between px-2 py-2 hover:bg-[#1A1A1A] cursor-pointer md:px-5"
        >
          <div className="flex items-center gap-2">
            <Image
          ...
          <button onClick={() => deleteHistory(history._id)} className="absolute right-6 z-10">
